...
static uint8_t cc1100_OOK_SA_33[CFG_REGISTER] = {
...
static uint8_t patable_power_433[8] = {0x1C,0x1C,0xC8,0xC8,0xC8,0xC8,0xC8,0xC8};
...
void CC1100::set_mode(uint8_t mode)
{
    ...
    switch (mode)
    {
        ...
        case 0x06:
                    ...
                    break;
        case 0x07:
                    spi_write_burst(WRITE_BURST,cc1100_OOK_SA_33,CFG_REGISTER);
                    break;
        case 0x08:
            spi_write_burst(WRITE_BURST,cc1100_OOK_SA_33_RX,CFG_REGISTER);
            break;
        default:
            spi_write_burst(WRITE_BURST, cc1100_GFSK_100_kb, CFG_REGISTER);
            break;
